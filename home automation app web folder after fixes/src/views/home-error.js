...
const HomeError = (props) => {
  return (
    <div className="home-error-container">
      ...
      <div className="home-error-energy-efficiency">
        <div className="home-error-home">
          ...
          <img
            ...
            className="home-error-vector5"
          />
          <span className="home-error-text44">Energy Efficiency Settings</span>
          <span className="home-error-text45">
            <span>50%</span>
          </span>
        </div>
      </div>
